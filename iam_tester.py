"""
Create some temporary IAM credentials that use a particular policy document,
then create a client that uses that role.  This is useful for rapid testing and
experiments with IAM policy documents.
    ...
    with temporary_iam_credentials(
        admin_role=admin_role_arn, policy_document=policy_document
    ) as credentials:
